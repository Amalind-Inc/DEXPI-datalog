...
export default defineConfig({
  ...
  webServer: [
    {
      command:
        "PYDEXPI_DEPLOYMENT_PROFILE=local PYDEXPI_QA_PROVIDER=scripted PYDEXPI_QA_SCRIPTED_STEP_DELAY_MS=300 PYTHONPATH=.. PYDEXPI_REVIEW_ARTIFACT_ROOT=../.tmp/review-sessions ../.venv/bin/python -m uvicorn pydexpi_datalog.web.asgi:app --host 127.0.0.1 --port 8000",
